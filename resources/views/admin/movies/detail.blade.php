...
<div class="container m-4">
    ...
    <form action="{{ route('movie.detail', $movie) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input readonly type="text" class="form-control" name="title" value="{{$movie->title}}">
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea readonly class="form-control" name="intro" rows="3" >{{$movie->intro}}</textarea>
        </div>

        <div class="mb-3">
            <label class="form-label">Release_date</label>
            <input  readonly type="date" name="release_date" class="form-control" value="{{$movie->release_date}}">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Genre</label>
            <select readonly name="genre_id" class="form-select" id="">
